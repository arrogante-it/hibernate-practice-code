package jpaHibernateBasic.dao;

import jpaHibernateBasic.model.Account;

import java.util.List;

/*
provides an API to access {@link Account} data.
*/

public interface AccountDao {

    /*
     * Receives a new instance of {@link Account} and stores it into database.
     * Sets a generated id to account.
